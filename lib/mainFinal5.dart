        ...
        child: Row(children: [
          GestureDetector(
            ...
            child: Container(padding: const EdgeInsets.all(10),
              ...
              child: const Icon(Icons.keyboard_arrow_left_rounded, color: kPurple, size: 18))),
      ...
      child: Column(children: [
        ...
        SizedBox(width: double.infinity,
          child: OutlinedButton.icon(
            icon: const Icon(Icons.photo_camera_rounded, color: Color(0xFF11998E)),
            label: Text(
...
class _AuthScreenState extends State<AuthScreen>
  ...
  Widget _loginForm() => Column(children: [
    kTextField(_emailCtrl, L.get('email'), icon: Icons.alternate_email_rounded),
    const SizedBox(height: 14),
    kTextField(_passCtrl,  L.get('password'), icon: Icons.lock_person_rounded, obscure: true),
    const SizedBox(height: 8),
    Align(
  ...
  Widget _registerForm() => Column(children: [
    kTextField(_userCtrl,  L.get('username'), icon: Icons.face_rounded, accent: kPurple),
    const SizedBox(height: 12),
    kTextField(_emailCtrl, L.get('email'),    icon: Icons.alternate_email_rounded,  accent: kPurple),
    const SizedBox(height: 12),
    kTextField(_passCtrl,  L.get('password'), icon: Icons.lock_person_rounded,   accent: kPurple, obscure: true),
    const SizedBox(height: 20),
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        Image.network('https://www.google.com/favicon.ico',
          ...
          errorBuilder: (_, __, ___) =>
              const Icon(Icons.language_rounded, size: 24, color: Colors.red)),
        const SizedBox(width: 10),
        Text(
    ...
    Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        GestureDetector(onTap: dec,
          child: Icon(Icons.do_not_disturb_on_rounded, color: color, size: 22)),
...
class _ScanScreenState extends State<ScanScreen> with TickerProviderStateMixin {
  ...
  Widget _controls() => Row(
    ...
    children: _scanning
      ? [
          _btn(Icons.stop_circle_rounded,         Colors.orange, _finish),
          const SizedBox(width: 20),
          _btn(Icons.skip_next_rounded,  kGreen,       _finish),
        ]
      : [_btn(Icons.play_circle_outline_rounded, kCoral, _start)],
  );
  ...
  Widget _topBar(BuildContext context) => Row(children: [
    GestureDetector(
      ...
      child: Container(
        ...
        decoration: kCardDeco(radius: 14),
        child: const Icon(Icons.cottage_rounded, color: kCoral, size: 22))),
    const SizedBox(width: 12),
    ...
    return Dismissible(
      ...
      background: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20)),
        child: const Icon(Icons.delete_sweep_rounded, color: kCoral, size: 28)),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 8),
          Row(children: [
            _iconBtn(Icons.manage_history_rounded, kTurquoise, () async {
              final ip = await StorageService.getServerIp();
            ...
            const SizedBox(width: 6),
            _iconBtn(Icons.event_available_rounded, const Color(0xFF00B894), () =>
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => VetAppointmentsScreen(cat: cat, user: widget.user,
                  onRefresh: widget.onRefresh)))),
            const SizedBox(width: 6),
            _iconBtn(Icons.vaccines_rounded, kYellow, () =>
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => MedicationsScreen(cat: cat, user: widget.user,
                  onRefresh: widget.onRefresh)))),
            const SizedBox(width: 6),
            _iconBtn(Icons.qr_code_scanner_rounded, kPurple, () =>
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => QrGeneratorScreen(cat: cat, user: widget.user)))),
            const SizedBox(width: 6),
            _iconBtn(Icons.delete_sweep_rounded, kCoral, () => _deleteCat(cat)),
          ]),
        ])),
      ]),
    );
    ...
    body: SafeArea(child: SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          decoration: kCardDeco(),
          child: Column(children: [
            _row(Icons.security_rounded, kPurple,
              L.lang == 'es' ? 'Cambiar contrasena' : 'Change password',
              () => _changePassword(context)),
            _divider(),
            _row(Icons.verified_user_rounded, kTurquoise,
            ...
            _divider(),
            _row(Icons.delete_forever_rounded, kCoral,
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              const Icon(Icons.exit_to_app_rounded, color: kCoral, size: 20),
              const SizedBox(width: 10),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Row(children: [
            Icon(Icons.info_outlined, size: 13, color: kMuted),
            const SizedBox(width: 6),
            Expanded(child: Text(
              L.lang == 'en'
...
class _VomitoScanScreenState extends State<VomitoScanScreen>
  ...
  Widget _controls() => Row(
    ...
    children: _scanning
      ...
      : [_btn(Icons.play_circle_outline_rounded, kPurple, _start)],
  );
            ...
            Row(children: [
              GestureDetector(
                ...
                child: Container(
                  padding: const EdgeInsets.all(10),
                  decoration: kCardDeco(radius: 14),
                  child: const Icon(Icons.cottage_rounded, color: kPurple, size: 22))),
              const SizedBox(width: 12),
...
class _MedicoScanBaseState extends State<_MedicoScanBase> {
    ...
    child: Row(children: [
      GestureDetector(
        ...
        child: Container(padding: const EdgeInsets.all(8),
          ...
          child: const Icon(Icons.keyboard_arrow_left_rounded, color: Colors.white, size: 18))),
      const Spacer(),
  ...
  Widget _controls() => Row(mainAxisAlignment: MainAxisAlignment.center,
    children: _scanning
      ...
      : [_btn(Icons.play_circle_outline_rounded, kTurquoise, _start)]);
  ...
  Widget _buildResult() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(width: double.infinity,
          child: OutlinedButton.icon(
            icon: const Icon(Icons.videocam_sharp, color: kPurple),
            ...
            if (await canLaunchUrl(mapsApp)) {
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: kCoral.withOpacity(0.3))),
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  const Icon(Icons.local_pharmacy_rounded, color: kCoral, size: 22),
                  const SizedBox(width: 10),
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              GestureDetector(
                ...
                child: Container(padding: const EdgeInsets.all(10),
                  decoration: kCardDeco(radius: 14),
                  child: const Icon(Icons.autorenew_rounded, color: kTurquoise, size: 20))),
            ]),
          ),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: kCardDeco(border: kPurple.withOpacity(0.2)),
                child: Row(children: [
                  const Icon(Icons.event_available_rounded, color: Color(0xFF00B894), size: 20),
                  const SizedBox(width: 10),
                  Text(DateFormat('EEE dd MMM yyyy – HH:mm').format(selDate),
                    style: _nunito(14, kText, weight: FontWeight.w700)),
                  const Spacer(),
                  const Icon(Icons.draw_rounded, color: kMuted, size: 16),
                ]))),
            const SizedBox(height: 16),
            SizedBox(width: double.infinity,
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(14)),
            child: Center(child: Icon(Icons.local_pharmacy_rounded,
              color: accentColor, size: 22))),
          const SizedBox(width: 12),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
          ...
          Column(children: [
            GestureDetector(
              ...
              child: const Icon(Icons.draw_rounded, color: kMuted, size: 18)),
            const SizedBox(height: 8),
            GestureDetector(
              onTap: () async {
              ...
              child: Icon(
                a.completed ? Icons.task_alt_rounded : Icons.circle_outlined,
            ...
            GestureDetector(
              ...
              child: const Icon(Icons.delete_forever_rounded, color: kCoral, size: 18)),
          ]),
        ])));
  }
}
          ...
          child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  isExpanded: true,
                  icon: const Icon(Icons.expand_more_rounded, color: kYellow),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  const Icon(Icons.alarm_on_rounded, color: kYellow, size: 20),
                  const SizedBox(width: 10),
                  Text(
      ...
      child: Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14)),
          child: Center(child: Icon(Icons.vaccines_rounded,
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 4),
          Row(children: [
            Icon(Icons.replay_rounded, size: 12, color: kYellow),
            const SizedBox(width: 4),
            Text(m.frequency, style: _nunito(11, kYellow, weight: FontWeight.w700)),
            const SizedBox(width: 10),
            Icon(Icons.alarm_on_rounded, size: 12, color: kPurple),
            const SizedBox(width: 4),
        ...
        Column(children: [
          ...
          GestureDetector(
            ...
            child: Icon(
              m.active ? Icons.pause_circle_outline_rounded : Icons.play_circle_outline_rounded,
